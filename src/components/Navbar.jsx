  ...
  return (
    <nav className="glass-panel py-3 transition-all duration-300" style={{ top: 0, position: 'fixed', width: '100%', zIndex: 1000, borderRadius: 0, borderTop: 'none', borderLeft: 'none', borderRight: 'none' }}>
      <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <a href="#home" className="logo" style={{ display: 'flex', alignItems: 'center', gap: '12px', fontSize: '1.5rem', fontWeight: '700', color: 'var(--text-main)', textDecoration: 'none' }}>
        ...
        {/* Desktop Nav */}
        <div className="desktop-nav" style={{ gap: '24px', alignItems: 'center' }}>
